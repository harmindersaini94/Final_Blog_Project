...
const Footer = () => {
  return (
    ...
    //   <section className="py-4 bg-white border border-t-2 border-t-black">
    //   <div className="m-auto flex flex-wrap items-center justify-center gap-4 text-xl">
    ...
    //         <Logo/>
    //       </div>
    //       <div className="w-full p-1 md:w-1/3 lg:w-2/12">
    ...
    //     </div>
    //     <div>
    //       <p className="text-center -my-1.5 text-sm text-gray-600">
    //         &copy; Copyright 2024. All Rights Reserved by HarmSS.
    //       </p>
    //     </div>
    //   </section>
    // </footer>
    ...
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              ...
              <Logo/>
                  <span className=" m-3 self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Blog by HS</span>
              </Link>
          </div>
